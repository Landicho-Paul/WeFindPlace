    ...
    <footer class="page-footer">
      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            Head Office: WeFindPlace.<br>
            Angeles Pampanga
          </address>
            <div class="phone">
              Telephone:
              <a class="phone__number" href="tel:0123456789">0948-817-0896</a>
            </div>
            <div class="email">
              Email:
              <a href="mailto:support@yourwebsite.com" class="email__addr">WeFindPlace@gmail.com</a>
            </div>
          </div>
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
          ...
          <div class="developer">
            Developed by Paul Landicho
          </div>

          <div class="designby">
            Design by Paul Landicho
          </div>
